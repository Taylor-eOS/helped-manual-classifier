...
BASE_FEATURES = ['odd_even', 'x0', 'y0', 'width', 'height', 'position', 'word_count', 'font_size', 'relative_font_size', 'num_lines', 'punctuation_proportion', 'average_words_per_sentence', 'starts_with_number', 'capitalization_proportion', 'average_word_commonality', 'squared_entropy', 'dist_prev_norm', 'dist_next_norm']
SCALES = {
    'x0': 'doc_width',
    'y0': 'doc_height',
    'width': 'doc_width',
...
NORM_FEATURES = ['word_count', 'num_lines', 'average_words_per_sentence', 'average_word_commonality', 'squared_entropy', 'dist_prev_norm', 'dist_next_norm', 'font_size']
global_features = 4
